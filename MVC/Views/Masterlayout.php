...
<body> 
    <div class="container-fluid"> 
     ...
     id="menuIcon">
     <div id="menuDropdown" style="display: none; position: absolute; top: 40px; right: 10pxund: whi; backgrote; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); border-radius: 4px; width: 200px; z-index: 10;">
    <a href="http://localhost/Doan/Thongtinad" id="userInfo" name="userInfo" style="display: block; padding: 10px; text-decoration: none; color: black; font-size: 14px; border-bottom: 1px solid #e0e0e0;">Thông tin người dùng</a>
                ...
                <div class="list-group"> 
                    ...
                    <span id="arrow" class="fas fa-chevron-down" style="float: right; margin-left: 10px;"></span> 
                            ...
                            <div id="submenuDetai" style="display: none; padding-left: 20px;">
                                <a href="http://localhost/Doan/Sinhvien" class="list-group-item">Quản Lý Sinh Viên</a>
                                <a href="http://localhost/Doan/Giangvien" class="list-group-item">Quản Lý Giảng Viên</a>
                                <a href="http://localhost/Doan/Quanlykhoa" class="list-group-item">Quản Lý Khoa </a>
                                <a href="http://localhost/Doan/QuanlyDT" class="list-group-item">Quản Lý Đề Tài </a>
                                <a href="http://localhost/Doan/QuanlyTK" class="list-group-item">Quản Lý Tài Khoản </a>
                              
                            </div>

                    <a href="http://localhost/Doan/ThongbaoHS" class="list-group-item"> 
                    ...
                    <a href="http://localhost/Doan/Danhgia" class="list-group-item">
