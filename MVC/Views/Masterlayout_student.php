...
<body> 
    ...
    <a href="http://localhost/Doan/Thongtinsv" id="userInfo" style="display: block; padding: 10px; text-decoration: none; color: black; font-size: 14px; border-bottom: 1px solid #e0e0e0;">Thông tin người dùng</a>
        ...
        <div class="row"> 
            <div class="menu_left1"> 
                <div class="list-group"> 
                    <a href="http://localhost/Doan/Home/student" class="list-group-item "> 
                    ...
                    <span id="arrow" class="fas fa-chevron-down" style="float: right; margin-left: 10px;"></span> 
                            ...
                            <div id="submenuDetai" style="display: none; padding-left: 20px;">
                                <a href="http://localhost/Doan/SVdangkydt" class="list-group-item">Đăng ký đề tài</a>
                                <a href="http://localhost/Doan/ChitietDT" class="list-group-item">Chi Tiết Đề Tài</a>
                            </div>

                    <a href="http://localhost/Doan/Xemthongbao" class="list-group-item"> 
                    ...
                    <a href="http://localhost/Doan/Danhgiasv" class="list-group-item">
