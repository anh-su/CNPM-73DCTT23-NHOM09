...
<body>
    <div class="container">
        <div class="info-box">
            ...
            <form method="post" action="http://localhost/Doan/Thongtinad/updatead">
                <div class="form-row">
                    <!-- Cột bên trái -->
                ...
                <div class="form-group d-flex justify-content-end">
                    <button type="submit" name="btncapnhatad" class="btn btn-primary">Lưu thay đổi</button>
                </div>
            </form>
        </div>
    </div>
