...
<form method="post" action="http://localhost/Doan/Giangvien/themmoi">
   ...
   <img src="http://localhost/Doan/Public/Pictures/edit.gif" alt="Edit">
                                    ...
                                    <a href="http://localhost/Doan/Giangvien/deleteGiangvien/<?php echo $row['ID_Giangvien']; ?>">
    ...
    <div class="modal-dialog" role="document" style="max-width: 800px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="http://localhost/Doan/Giangvien/capnhatgv" id="editGiangvienForm">
                    <div class="form-row">
