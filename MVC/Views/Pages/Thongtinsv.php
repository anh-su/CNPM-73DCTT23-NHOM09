...
<body>
    <div class="container">
        <div class="info-box">
            ...
            <form method="post" action="http://localhost/Doan/Thongtinsv/updatesv">
                <div class="form-row">
                    <!-- Cột bên trái -->
                    <div class="form-column column-left">
                        ...
                        <div class="admin-label">
                            Mã Sinh Viên: <?php echo $_SESSION['ID']; ?>
                        </div>
                    </div>
                ...
                <div class="form-group d-flex justify-content-end">
                    <button type="submit" name="btncapnhatsv" class="btn btn-primary">Lưu thay đổi</button>
                </div>
            </form>
        </div>
    </div>
