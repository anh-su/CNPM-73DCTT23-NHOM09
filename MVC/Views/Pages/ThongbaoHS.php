...
<div style="margin-top: 1rem !important;" class="container mt-5">
    ...
    <form id="formThongbao" action="http://localhost/Doan/ThongbaoHS/saveThongbao" method="POST">
        <hr class="custom-hr">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForm" method="POST" action="http://localhost/Doan/ThongbaoHS/suaThongbao">
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="deleteForm" action="http://localhost/Doan/ThongbaoHS/xoaThongbao" method="POST">
                <div class="modal-header">
...
<script>
    $(document).ready(function() {
        ...
        $('#deleteForm').submit(function(e) {
            ...
            $.ajax({
                url: 'http://localhost/Doan/ThongbaoHS/xoaThongbao/' + id,
                type: 'POST',
        ...
        $('#confirmResetButton').click(function() {
            $.ajax({
                url: 'http://localhost/Doan/ThongbaoHS/resetThongbao',
                type: 'POST',
                success: function(response) {
