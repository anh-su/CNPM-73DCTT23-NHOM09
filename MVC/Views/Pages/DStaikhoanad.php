...
<body>
  <h4 class="mb-2">ĐĂNG KÝ TÀI KHOẢN ADMIN</h4>
  <hr class="custom-hr">

  <!-- Form Đăng Ký -->
  <div class="form-container">
    <form method="post" action="http://localhost/Doan/DStaikhoanad/themmoi">
      <div class="form-row">
      ...
      <div class="form-row">
        <div class="form-group col-sm-12">
          <label for="myID_Admin">ID Admin</label>
          <input type="text" class="form-control" id="myID_Admin" name="txtID_Admin" required>
        </div>
      </div>

      <div class="form-group">
        <button style="background-color: #26a69a;" type="submit" class="btn btn-primary" name="btnThemAdmin">Đăng Ký Tài Khoản</button>
      </div>
    </form>
  </div>
  ...
  <form method="post" action="http://localhost/Doan/DStaikhoanad/timkiemad">
    <br>
    <hr class="custom-hr">
    ...
    <div class="form-group" style="margin-left: 1cm;">
        <label for="myID_Admin">ID Admin: </label>
        <input type="text" class="form-control1" id="myID_Admin" placeholder="" name="txtID_Admin" value="<?php if (isset($data['ID_Admin'])) echo $data['ID_Admin'] ?>">
    </div>
    <div class="form-group">
    <button style="margin-left: 1cm; background-color: #26a69a;" type="submit" class="btn btn-primary" name="btnTimkiemad">Tìm Kiếm</button>
    </div>
    <div class="form-group">
    ...
    <table class="table table-striped">
        ...
        <?php if (!empty($data['danhSachTaiKhoanad'])) : 
                     $i = 0; ?>
            <?php foreach ($data['danhSachTaiKhoanad'] as $DStaikhoanad) : ?>
            <tr>
                        
                <td><?php  echo (++$i) ?></td>
                <td><?php echo $DStaikhoanad['ID_TK'] ?></td>
                <td><?php echo $DStaikhoanad['Tendangnhap'] ?></td>
                <td><?php echo $DStaikhoanad['Matkhau'] ?></td>
                <td><?php echo $DStaikhoanad['Vaitro'] ?></td>
                <td><?php echo $DStaikhoanad['ID_Admin'] ?></td>
                <td>
                    <a href="#" class="edit-link" data-ID_TK="<?php echo $DStaikhoanad['ID_TK']; ?>" data-Tendangnhap="<?php echo $DStaikhoanad['Tendangnhap']; ?>" data-Matkhau="<?php echo $DStaikhoanad['Matkhau']; ?>" data-Vaitro="<?php echo $DStaikhoanad['Vaitro']; ?>" data-ID_Admin="<?php echo $DStaikhoanad['ID_Admin']; ?>" data-toggle="modal" data-target="#editModal">
                        <img src="http://localhost/Doan/Public/Pictures/edit.gif" alt="Edit">
                    </a>
                    <a href="http://localhost/Doan/DStaikhoanad/xoaad/<?php echo $DStaikhoanad['ID_TK'] ?>">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="http://localhost/Doan/DStaikhoand/capnhatgad">
                    <div class="container-fluid mt-3">
                        ...
                        <div class="form-group col-sm-6">
                            <label for="modalID_Admin">ID Admin</label>
                            <input type="text" class="form-control" id="modalID_Admin" name="txtID_Admin" readonly>
                        </div>
                        </div>
