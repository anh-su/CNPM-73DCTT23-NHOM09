...
<body>
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="info-box">
                <img src="http://localhost/Doan/Public/Pictures/130manstudent2_100617.png" alt="Nguyễn Tiến Hưng" style="width: 50%; border-radius: 50%; margin-bottom: 15px;">
                <h3>Nguyễn Tiến Hưng</h3>
            </div>
        </div>
        <div class="col-md-3">
            <div class="info-box">
                <img src="http://localhost/Doan/Public/Pictures/130manstudent2_100617.png" alt="Quang Hồng Ánh Sứ" style="width: 50%; border-radius: 50%; margin-bottom: 15px;">
        ...
        <div class="col-md-3">
            <div class="info-box">
                <img src="http://localhost/Doan/Public/Pictures/132womanstudent2_100407.png" alt="Ngô Thị Thanh Vân" style="width: 50%; border-radius: 50%; margin-bottom: 15px;">
        ...
        <div class="col-md-3">
            <div class="info-box">
                <img src="http://localhost/Doan/Public/Pictures/130manstudent2_100617.png" alt="Lê Xuân Đạt" style="width: 50%; border-radius: 50%; margin-bottom: 15px;">
                <h3>Lê Xuân Đạt</h3>
