<?php
class Thongtinsv_m extends connectDB
{
    // Cập nhật thông tin admin
    function Thongtinsv_upd($ID_Sinhvien, $Hoten, $Ngaysinh, $Diachi, $Email, $Sdt, $Gioitinh)
    {
        // Sử dụng Prepared Statements để bảo vệ khỏi SQL Injection
        $sql = "UPDATE sinhvien SET Hoten = ?, Ngaysinh = ?, Diachi = ?, Email = ?, Sdt = ?, Gioitinh = ? WHERE ID_Sinhvien = ?";
        ...
        $stmt->bind_param("sssssss", $Hoten, $Ngaysinh, $Diachi, $Email, $Sdt, $Gioitinh, $ID_Sinhvien);
